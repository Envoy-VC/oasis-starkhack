...
export class ActionsCalls extends BaseCalls {
  ...
  async updateBoard(
    ...
    try {
      const res = await this.execute(account, 'update_board', [
        game_id,
        board_id.data,
        board_id.pending_word,
        board_id.pending_word_len,
      ]);
  ...
  async ownerOf(
    ...
    try {
      const res = await this.execute(account, 'owner_of', [token_id, game_id]);
  ...
  async tokenUri(
    ...
    try {
      const res = await this.execute(account, 'token_uri', [token_id, game_id]);
  ...
  async mint(
    ...
    try {
      const res = await this.execute(account, 'mint', [
        ...
        game_id,
        token_uri.data,
        token_uri.pending_word,
        token_uri.pending_word_len,
      ]);
